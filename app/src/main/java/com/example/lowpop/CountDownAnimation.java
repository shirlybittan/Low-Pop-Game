...
public class CountDownAnimation {
    ...
    //showing the numbers while countdown>0
    ...
    /*Creates a count down animation in the textView, starting from startCount
    By default, the class defines a fade out animation, which uses from 1 to 0.
...
//Cancels the count down animation.
  ...
  // Sets the animation used during the count down.
    // If the duration of the animation for each number is not set, one second will be defined.
   ...
   //start countdown: The starting count number
    ...
    //Binds a listener to this count down animation.
    // The count down listener is notified of events such as the end of the animation.
...
// Notifications indicate count down animation related events, such as the end of the animation.
